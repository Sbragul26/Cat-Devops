...
const projects = [
  {
    ...
    githubLink: "https://github.com/Sbragul26/wqi.dev",
    appLink: "https://tradeguard-wqi.vercel.app/",
    isPrivate: false,
    hosted: true,
  },
  {
    ...
    githubLink: "https://github.com/Sbragul26/nexora-creations",
    appLink: "https://nexora-creations.vercel.app/",
    isPrivate: false,
    hosted: true,
  },
  {
    ...
    githubLink: "https://github.com/Sbragul26/SMS-Spam-classifier",
    appLink: "",
    isPrivate: false,
    hosted: false,
  },
  {
    id: 4,
    title: "DarkDock",
    subtitle: "Cybersecurity & DevOps Project",
    description:
      "Developed a secure and private website hosting solution for the Dark Web using Docker and Tor. DarkDock creates a Tor Onion Service that allows websites to be accessed via a .onion address, ensuring complete anonymity and system isolation. The setup leverages Docker containers to separate Tor and Nginx services, maintaining high security and easy deployment for both x86_64 and ARM architectures.",
    technologies: ["Docker", "Tor", "Nginx", "Linux", "Bash"],
    githubLink: "https://github.com/Sbragul26/DarkDock",
    appLink: "",
    isPrivate: false,
    hosted: false,
  },
  {
    id: 5,
    title: "Ocean Lens",
    subtitle: "AI & Data Visualization for Ocean Analytics",
    description:
      "Developed an AI-powered conversational system that simplifies the exploration and visualization of complex ARGO ocean data. OceanLens transforms NetCDF datasets into easy-to-understand insights through natural language queries, interactive dashboards, and real-time alerts. The platform integrates AI models for anomaly detection and forecasting, helping researchers and policymakers make data-driven ocean safety decisions.",
    technologies: [
      "Next.js",
      "Tailwind CSS",
      "Node.js",
    ...
    githubLink: "https://github.com/Sbragul26/ocean_data_explorer",
    appLink: "https://oceanlens.vercel.app/",
    isPrivate: false,
    hosted: true,
  },
  ...
  return (
    ...
    >
      <motion.h1
        className="text-xl sm:text-2xl md:text-3xl font-heading font-bold mb-6 sm:mb-8 md:mb-12 px-2 sm:px-4 md:px-6 text-center sm:text-left mt-10"
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <button
              ...
              className="px-4 sm:px-6 py-2 sm:py-3 bg-white border border-gray-300 rounded-md shadow-sm text-gray-900 text-sm sm:text-base font-bold hover:bg-gray-50 transition-colors"
            >
