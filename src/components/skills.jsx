...
import archImage from "../assets/archImage.svg";
...
function Skills() {
  ...
  const languages = [
    ...
    {Icon : SiTypescript,name:"TypeScript" ,image :typeScript},
  ];
  ...
  const servicesLibraries = [
    ...
    { Icon: SiArchlinux , name: "Arch Linux" , image:archImage},
  ];
  ...
  return (
    <div
      className="flex flex-col max-w-6xl mx-auto px-4 sm:px-6 mt-20"
      ref={sectionRef}
    >
